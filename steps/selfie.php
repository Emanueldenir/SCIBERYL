            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default" style="background: url('') no-repeat;">
                    <div class="panel-heading" style="padding:5px">
                        ...
                        <h2 id="titre_authent" style="margin-top:12px;" class="text-center">Verification faciale</h2>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <h3>
                                    Vérification traits de visage
                                </h3>
                                <form style="width: 100%" enctype="multipart/form-data" id="file-upload-form" action="../actions/selfie.php" method="post">
                                    <input required id="file-upload" type="file" name="fileUpload" />
                                    <label for="file-upload" id="file-drag">
                                        Sélectionnez votre selfie
                                        <br />OU
                                        <br />Faites glisser le fichier dans cette zone
                                        
                                        <br /><br /><span id="file-upload-btn" class="button">Ajouter votre selfie</span>
                                    </label>
                                ...
                                <div>
                                    <h6>Assurer vous que toutes les parties de votre visage soient visibles et sans filtre. Cette dernière vérification nous permets de nous assurer qu'il s'agit bien de vos documents.</h6>
                                    <div style="text-align: center;">
                                        <img style="width: 100px" src="../assets/images/kyc-success.png">
                                        <img style="width: 100px" src="../assets/images/kyc-echec.png">
                                    </div>
                                </div>
                                <br>
                                <div class="col-md-12">
