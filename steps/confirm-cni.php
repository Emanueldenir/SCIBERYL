                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <h3>
                                    Veuillez envoyer le recto de votre CNI
                                </h3>
                                <form style="width: 100%" enctype="multipart/form-data" id="file-upload-form" action="../actions/cni-recto.php" method="post">
                                    ...
                                    <label for="file-upload" id="file-drag">
                                        ...
                                        <br /><br /><span id="file-upload-btn" class="button">Ajouter le recto</span>
                                    </label>
                                ...
                                <div>
                                    <img style="width: 80%" src="../assets/images/recto.png">
