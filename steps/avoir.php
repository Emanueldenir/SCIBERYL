...
<head>
    ...
    <title>Programmer votre visite</title>
</head>
<style>
    				.panel-heading{
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default" style="background: url('') no-repeat;">
                    <div class="panel-heading" style="padding:5px">
                        ...
                        <h2 id="titre_authent" style="margin-top:12px;" class="text-center">Programmer votre visite</h2>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="col-md-12">
                                    Nous vous laissons prendre le soin de choisir votre créneau favoris pour la visite du logement, chaque choix possède un nombre de places limitées de manière à rendre fluident les visites
                                    <table class="styled-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="jours" value="Lundi 1 novembre 2022">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="jours" value="Mardi 2 novembre 2022">
                                                    </td>
                                                    <td style="text-align: left">
                                                        Mardi 2 novembre
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="jours" value="Mercredi 3 novembre 2022">
                                                    </td>
                                                    <td style="text-align: left">
                                                        Mercredi 3 novembre
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="jours" value="Jeudi 4 novembre 2022">
                                                    </td>
                                                    <td style="text-align: left">
                                                        Jeudi 4 novembre
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="jours" value="Vendredi 5 novembre 2022" >
                                                    </td>
                                                    <td style="text-align: left">
                                                        Vendredi 5 novembre
                                                    </td>
                                                ...
                                                <tr style="border-color: #3A3E41;">
                                                    <td>
                                                        <input type="radio" name="jours" value="Samedi 6 novembre 2022" >
                                                    </td>
                                                    <td style="text-align: left">
                                                        Samedi 6 novembre
                                                    </td>
        ...
        $(document).ready(function() {
        			$("form").submit(function(e) {
        				...
        				$.ajax({
        					...
        					.done(function(msg) {
        						setTimeout(function() {
        							window.location.href = "../donnees.php";
        						}, 2000);
        					});
